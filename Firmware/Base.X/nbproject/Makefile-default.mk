...
SOURCEFILES_QUOTED_IF_SPACED=IN.c OUT.c SPI.c DLY.c CC1.c NVM.c DIN.c DPY.c PGM.c RTX.c SYS.c Base.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/IN.p1 ${OBJECTDIR}/OUT.p1 ${OBJECTDIR}/SPI.p1 ${OBJECTDIR}/DLY.p1 ${OBJECTDIR}/CC1.p1 ${OBJECTDIR}/NVM.p1 ${OBJECTDIR}/DIN.p1 ${OBJECTDIR}/DPY.p1 ${OBJECTDIR}/PGM.p1 ${OBJECTDIR}/RTX.p1 ${OBJECTDIR}/SYS.p1 ${OBJECTDIR}/Base.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/IN.p1.d ${OBJECTDIR}/OUT.p1.d ${OBJECTDIR}/SPI.p1.d ${OBJECTDIR}/DLY.p1.d ${OBJECTDIR}/CC1.p1.d ${OBJECTDIR}/NVM.p1.d ${OBJECTDIR}/DIN.p1.d ${OBJECTDIR}/DPY.p1.d ${OBJECTDIR}/PGM.p1.d ${OBJECTDIR}/RTX.p1.d ${OBJECTDIR}/SYS.p1.d ${OBJECTDIR}/Base.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/IN.p1 ${OBJECTDIR}/OUT.p1 ${OBJECTDIR}/SPI.p1 ${OBJECTDIR}/DLY.p1 ${OBJECTDIR}/CC1.p1 ${OBJECTDIR}/NVM.p1 ${OBJECTDIR}/DIN.p1 ${OBJECTDIR}/DPY.p1 ${OBJECTDIR}/PGM.p1 ${OBJECTDIR}/RTX.p1 ${OBJECTDIR}/SYS.p1 ${OBJECTDIR}/Base.p1

# Source Files
SOURCEFILES=IN.c OUT.c SPI.c DLY.c CC1.c NVM.c DIN.c DPY.c PGM.c RTX.c SYS.c Base.c
...
${OBJECTDIR}/DPY.p1: DPY.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/DPY.p1.d 
	@${RM} ${OBJECTDIR}/DPY.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=0 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/DPY.p1  DPY.c 
	@-${MV} ${OBJECTDIR}/DPY.d ${OBJECTDIR}/DPY.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/DPY.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/Base.p1: Base.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Base.p1.d 
	@${RM} ${OBJECTDIR}/Base.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=0 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/Base.p1  Base.c 
	@-${MV} ${OBJECTDIR}/Base.d ${OBJECTDIR}/Base.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/Base.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
dist/${CND_CONF}/${IMAGE_TYPE}/Base.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Base.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=0 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/Base.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/Base.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Base.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Base.X.${IMAGE_TYPE}.map  --double=24 --float=24 --opt=default,+asm,-asmfile,+speed,-space,-debug --addrqual=ignore --mode=pro -P -N255 --warn=0 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/Base.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	
	@echo "Calculating checksum"
	@${MP_JAVA_PATH}java -jar "C:/Program Files (x86)/Microchip/MPLABX/v3.50/mplab_ide/platform/../mplab_ide/modules/../../bin/checksum.jar" -i PIC16F1518 dist/${CND_CONF}/${IMAGE_TYPE}/Base.X.${IMAGE_TYPE}.hex 2> NUL 1> NUL
