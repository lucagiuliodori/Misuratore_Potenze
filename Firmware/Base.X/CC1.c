...
//Definizioni macro.
#define mCc1Init() IOCBP=0b00000000; IOCBN=0b00000000
...
void CC1Init(unsigned char state)
{
	...
	switch(state)
	{
		...
		case 2:
            ...
            //Reset CC1101.
			CC1Strobe(SRES);
            //Ritardo di attesa per il reset.
            DLYDelay_ms(5);
			CC1Write(0x00,cc1InitVal,SIZE_INIT_VAL);
			CC1Write(0x3E,cc1PaTable,SIZE_PATABLE);
//            //Lettura delle configurazioni per test programmazione CC1101.
//            unsigned char cc1InitVal_tmp[SIZE_INIT_VAL];
//            CC1Read(0x00,cc1InitVal_tmp,SIZE_INIT_VAL);
//            NOP();
			break;
	}
}
