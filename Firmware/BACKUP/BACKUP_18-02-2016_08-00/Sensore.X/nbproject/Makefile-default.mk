...
dist/${CND_CONF}/${IMAGE_TYPE}/Sensore.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	@${MP_JAVA_PATH}java -jar "C:/Program Files (x86)/Microchip/MPLABX/v3.05/mplab_ide/mplab_ide/modules/../../bin/checksum.jar" -i PIC16F1518 dist/${CND_CONF}/${IMAGE_TYPE}/Sensore.X.${IMAGE_TYPE}.hex 2> NUL 1> NUL
